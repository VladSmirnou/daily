...
// must find the difference of the cuboids' volumes regardless of which is bigger.
...
function findDifference(a, b) {
    return Math.abs(a.reduce((acc, newVal) => acc * newVal) - b.reduce((acc, newVal) => acc * newVal));
}