...
// known for almost always capitalizing every word. For simplicity, you'll
// have to capitalize each word, check out how contractions are expected to
...
String.prototype.toJadenCase = function () {
    return this.replace(/([a-z0-9'"]+)/gi, mO => `${mO[0].toUpperCase()}${mO.substring(1)}`);
};
